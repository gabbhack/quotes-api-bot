...
dp.register_message_handler(handlers.cmd_key, commands=["key"], chat_type=["private"])
dp.register_message_handler(handlers.cmd_revoke, commands=["revoke"], chat_type=["private"])
